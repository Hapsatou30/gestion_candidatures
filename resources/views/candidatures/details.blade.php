...
@section('content')
    ...
    <div class="container">
        <div class="candidature-detail">
            ...
            <div class="info">
                <img src="{{ asset('storage/' . $candidature->candidat->photo) }}"
                    alt="Photo de {{ $candidature->candidat->prenom }} {{ $candidature->candidat->nom }}">
                <div class="name">
        ...
        <div class="cv">
            ...
            <p>CV <a href="{{ asset('storage/' . $candidature->candidat->cv) }}" class="btn btn-danger" target="_blank"><i
        ...
        @else
            <div class="reponse">
                <p>La candidature a déjà été {{ $candidature->etat }}.</p>
            </div>
        @endif

        <a href="/listeCandidatPostulez/{{$candidature->formation->id}}" class="btn btn-danger">Retour</a>
    </div>
@endsection
