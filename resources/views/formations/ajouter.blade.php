                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    class="form-control @error('cohorte') is-invalid @enderror"
                                                    id="cohorte" name="cohorte" value="{{ old('cohorte') }}">
                                                @error('cohorte')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select id="statut" name="statut"
                                                    ...
                                                    <option value="ouverte"
                                                        {{ old('statut') == 'ouverte' ? 'selected' : '' }}>Ouverte</option>
                                                    <option value="fermée"
                                                        {{ old('statut') == 'fermée' ? 'selected' : '' }}>Fermée</option>
                                                </select>
                                                @error('statut')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
